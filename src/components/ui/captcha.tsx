...
export function Captcha({ onCaptchaChange }: CaptchaProps) {
  ...
  return (
    <div className="space-y-3">
      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Captcha Verification *</label>
      ...
      <div className="flex items-center space-x-3">
        ...
        <canvas
          ...
          width={180}
          height={50}
          className="border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700"
        />
