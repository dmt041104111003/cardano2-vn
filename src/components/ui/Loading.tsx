...
export default function Loading() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-white/95 transition-opacity">
      <div className="pointer-events-none select-none fixed right-0 top-1/2 -translate-y-1/2 translate-x-1/2 z-0 opacity-20">
        <div className="relative w-[1500px] h-[1500px] md:w-[2400px] md:h-[2400px] rounded-full bg-gradient-to-br from-[#00A3FF]/10 to-[#003C8C]/10">
