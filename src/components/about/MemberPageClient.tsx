...
function AboutContactForm({ formData, errors, isSubmitting, onInputChange, onSubmit }: {
        ...
        >
          {isSubmitting ? (
            <div className="flex items-center justify-center">
              <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-white dark:text-blue-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="max-w-2xl mx-auto text-lg text-gray-700 dark:text-gray-300">
              Ready to contribute to the Cardano ecosystem? We're always looking for passionate individuals 
