export default function ProjectSkeleton() {
  return (
    <div className="w-full">
      <div className="group w-full rounded-sm border border-white/20 bg-gray-800/50 shadow-xl backdrop-blur-sm">
        <div className="flex w-full">
          ...
          <div className="flex w-32 flex-col justify-center bg-green-900/30 rounded-r-lg p-4">
            <div className="flex flex-col items-end space-y-2">
              ...
              <div className="h-4 bg-gray-700 rounded animate-pulse w-16 mt-4"></div>
            </div>
          </div>
        </div>
      </div>
