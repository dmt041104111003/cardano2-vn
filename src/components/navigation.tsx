    ...
    <div className="mb-8 w-full md:w-80">
      <Tabs defaultValue="time" className="rounded-none">
        <TabsList
          ...
          className="items-center justify-center p-1 text-accent-foreground grid w-full grid-cols-2 rounded-sm outline-none h-10 border border-white/20 bg-gray-800/50 backdrop-blur-sm"
        >
          <TabsTrigger
            value="time"
