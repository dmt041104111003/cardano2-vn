                ...
                <div className="w-full md:w-80 md:shrink-0 md:pr-8">
                  ...
                  >
                    <button
                      ...
                      role="tab"
                      aria-selected="true"
                      aria-controls="radix-:ri:-content-2023"
                      data-state="active"
                      id="radix-:ri:-trigger-2023"
                      className="inline-flex items-center whitespace-nowrap ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:shadow w-full justify-start rounded-sm border border-white/20 bg-gray-800/50 px-4 py-3 text-left text-sm font-medium text-white backdrop-blur-sm hover:bg-gray-700/50 data-[state=active]:bg-blue-600 data-[state=active]:text-white"
                      data-orientation="vertical"
                    ...
                    <button
                      ...
                      role="tab"
                      aria-selected="false"
                      aria-controls="radix-:ri:-content-2024"
                      data-state="inactive"
                      id="radix-:ri:-trigger-2024"
                      className="inline-flex items-center whitespace-nowrap ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:shadow w-full justify-start rounded-sm border border-white/20 bg-gray-800/50 px-4 py-3 text-left text-sm font-medium text-white backdrop-blur-sm hover:bg-gray-700/50 data-[state=active]:bg-blue-600 data-[state=active]:text-white"
                      data-orientation="vertical"
                      data-radix-collection-item=""
                    >
                    ...
                    <button
                      ...
                      role="tab"
                      aria-selected="false"
                      aria-controls="radix-:ri:-content-2025"
                      data-state="inactive"
                      id="radix-:ri:-trigger-2025"
                      className="inline-flex items-center whitespace-nowrap ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:shadow w-full justify-start rounded-sm border border-white/20 bg-gray-800/50 px-4 py-3 text-left text-sm font-medium text-white backdrop-blur-sm hover:bg-gray-700/50 data-[state=active]:bg-blue-600 data-[state=active]:text-white"
                      data-orientation="vertical"
                      data-radix-collection-item=""
                    >
                    ...
                    <button
                      ...
                      role="tab"
                      aria-selected="false"
                      aria-controls="radix-:ri:-content-2026"
                      data-state="inactive"
                      id="radix-:ri:-trigger-2026"
                      className="inline-flex items-center whitespace-nowrap ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:shadow w-full justify-start rounded-sm border border-white/20 bg-gray-800/50 px-4 py-3 text-left text-sm font-medium text-white backdrop-blur-sm hover:bg-gray-700/50 data-[state=active]:bg-blue-600 data-[state=active]:text-white"
                      data-orientation="vertical"
                      data-radix-collection-item=""
                    >
                    ...
                    <button
                      ...
                      role="tab"
                      aria-selected="false"
                      aria-controls="radix-:ri:-content-2027"
                      data-state="inactive"
                      id="radix-:ri:-trigger-2027"
                      className="inline-flex items-center whitespace-nowrap ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:shadow w-full justify-start rounded-sm border border-white/20 bg-gray-800/50 px-4 py-3 text-left text-sm font-medium text-white backdrop-blur-sm hover:bg-gray-700/50 data-[state=active]:bg-blue-600 data-[state=active]:text-white"
                      data-orientation="vertical"
                      data-radix-collection-item=""
                    >
                  ...
                  <a href="https://andamio.notion.site/1fb44d820e1d804ebec4f0142d3f267a?pvs=105">
                        ...
                        <div className="group w-full rounded-sm border border-white/20 bg-gray-800/50 shadow-xl backdrop-blur-sm transition-all hover:border-white/40 hover:shadow-2xl">
                          <div className="flex w-full">
                            <div className="flex-grow border-l-4 bg-gray-900/60 border-green-500 rounded-l-lg">
                              <div className="p-5">
                                <div className="mb-2 text-sm font-medium text-blue-400">Founding &amp; Vision</div>
                                <div className="mb-3">
                                  <h3 className="text-xl font-bold tracking-tight text-white">Andamio Founded</h3>
                                </div>
                            ...
                            <div className="flex w-32 flex-col justify-center bg-green-900/30 rounded-r-lg p-4">
                              <div className="flex flex-col items-end">
                                <div className="text-xl font-bold text-green-300">2023</div>
                                <div className="text-xl font-bold text-green-300">Q2</div>
                                <div className="mt-6 text-xs font-medium text-green-300">Complete</div>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="flex w-full">
                            <div className="flex-grow border-l-4 bg-gray-900/60 border-green-500 rounded-l-lg">
                              <div className="p-5">
                                <div className="mb-2 text-sm font-medium text-blue-400">Founding &amp; Vision</div>
                                <div className="mb-3">
                                  <h3 className="text-xl font-bold tracking-tight text-white">Team forming and Org-building</h3>
                                </div>
                                <p className="max-w-2xl text-sm text-gray-300">Clarifying itentions for Andamio in how we organize and build it</p>
                              </div>
                            </div>
                            <div className="flex w-32 flex-col justify-center bg-green-900/30 rounded-r-lg p-4">
                              <div className="flex flex-col items-end">
                          ...
                          <div className="flex w-full">
                            <div className="flex-grow border-l-4 bg-gray-900/60 border-green-500 rounded-l-lg">
                              <div className="p-5">
                                <div className="mb-2 text-sm font-medium text-blue-400">Founding &amp; Vision</div>
                                <div className="mb-3">
                                  <h3 className="text-xl font-bold tracking-tight text-white">Andamio system designs</h3>
                                </div>
                                <p className="max-w-2xl text-sm text-gray-300">
                            ...
                            <div className="flex w-32 flex-col justify-center bg-green-900/30 rounded-r-lg p-4">
                              <div className="flex flex-col items-end">
                                <div className="text-xl font-bold text-green-300">2023</div>
                                <div className="text-xl font-bold text-green-300">Q3</div>
                                <div className="mt-6 text-xs font-medium text-green-300">Complete</div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="w-full">
                        <div className="group w-full rounded-sm border border-white/20 bg-gray-800/50 shadow-xl backdrop-blur-sm transition-all hover:border-white/40 hover:shadow-2xl">
                          <div className="flex w-full">
                            <div className="flex-grow border-l-4 bg-gray-900/60 border-green-500 rounded-l-lg">
                              <div className="p-5">
                                <div className="mb-2 text-sm font-medium text-blue-400">Catalyst Proposals</div>
                                <div className="mb-3">
                                  <h3 className="text-xl font-bold tracking-tight text-white">
                                    F10: DAOs &lt;3 smart contracts for skill-acquisition and contribution tracking
                                  </h3>
                                </div>
                                <p className="max-w-2xl text-sm text-gray-300">
                            ...
                            <div className="flex w-32 flex-col justify-center bg-green-900/30 rounded-r-lg p-4">
                              <div className="flex flex-col items-end">
                                <div className="text-xl font-bold text-green-300">2023</div>
                                <div className="text-xl font-bold text-green-300">Q4</div>
                                <div className="mt-6 text-xs font-medium text-green-300">Complete</div>
                              </div>
                            </div>
                          </div>
